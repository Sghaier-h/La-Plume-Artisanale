-- ============================================================================
-- SCRIPT : Ajout d'Index Manquants pour Optimisation Performance
-- ============================================================================
-- 
...
--   - Via psql : psql -U user -d database -f add_missing_indexes.sql
--
-- ============================================================================
...
-- Factures -> BL (vérifier si colonne existe)
DO $$
BEGIN
    IF EXISTS (
...
-- ============================================================================
-- INDEX POUR TRAÇABILITÉ (created_by, updated_by)
-- ============================================================================

-- Index composites pour recherches par utilisateur et date
