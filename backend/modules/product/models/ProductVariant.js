/**
 * Productvariant Model - Module product
 */
...
export class Productvariant extends BaseModel {
  constructor() {
    super('product.productvariant', null);
    this._name = 'product.productvariant';
    this._description = 'Productvariant';
    this._table = 'product_variants';
    this._idField = 'id';
  }
