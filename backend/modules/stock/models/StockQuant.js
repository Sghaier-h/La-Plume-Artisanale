/**
 * Stockquant Model - Module stock
 */

import BaseModel from '../../../src/core/BaseModel.js';
import { pool } from '../../../src/utils/db.js';

export class Stockquant extends BaseModel {
  constructor() {
    super('stock.stockquant', null);
    this._name = 'stock.stockquant';
    this._description = 'Stockquant';
    this._table = 'stock_quants';
    this._idField = 'id';
  }

  async search(domain = [], options = {}) {
    let query = `SELECT * FROM stock_quants WHERE 1=1`;
    const params = [];
    let paramCount = 0;
