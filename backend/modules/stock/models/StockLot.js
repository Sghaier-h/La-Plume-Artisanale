/**
 * Stocklot Model - Module stock
 */

import BaseModel from '../../../src/core/BaseModel.js';
import { pool } from '../../../src/utils/db.js';

export class Stocklot extends BaseModel {
  constructor() {
    super('stock.stocklot', null);
    this._name = 'stock.stocklot';
    this._description = 'Stocklot';
    this._table = 'stock_lots';
    this._idField = 'id';
  }
