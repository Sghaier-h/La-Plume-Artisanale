/**
 * ExcelImport Model - Module excel-import
 */
...
export class ExcelImport extends BaseModel {
  constructor() {
    super('excel-import.excelimport', null);
    this._name = 'excel-import.excelimport';
    this._description = 'ExcelImport';
    this._table = 'excel-imports';
    this._idField = 'id';
  }

  async search(domain = [], options = {}) {
    let query = `SELECT * FROM excel-imports WHERE 1=1`;
    const params = [];
    let paramCount = 0;
