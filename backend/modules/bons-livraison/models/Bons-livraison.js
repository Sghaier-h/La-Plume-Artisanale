/**
 * BonsLivraison Model - Module bons-livraison
 */
...
export class BonsLivraison extends BaseModel {
  constructor() {
    super('bons-livraison.bonslivraison', null);
    this._name = 'bons-livraison.bonslivraison';
    this._description = 'BonsLivraison';
    this._table = 'bons-livraisons';
    this._idField = 'id';
  }

  async search(domain = [], options = {}) {
    let query = `SELECT * FROM bons-livraisons WHERE 1=1`;
    const params = [];
    let paramCount = 0;
