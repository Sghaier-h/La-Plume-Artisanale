/**
 * TracabiliteLots Model - Module tracabilite-lots
 */
...
export class TracabiliteLots extends BaseModel {
  constructor() {
    super('tracabilite-lots.tracabilitelots', null);
    this._name = 'tracabilite-lots.tracabilitelots';
    this._description = 'TracabiliteLots';
    this._table = 'tracabilite-lots';
    this._idField = 'id';
  }

  async search(domain = [], options = {}) {
    let query = `SELECT * FROM tracabilite-lots WHERE 1=1`;
    const params = [];
    let paramCount = 0;
