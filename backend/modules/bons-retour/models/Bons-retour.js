/**
 * BonsRetour Model - Module bons-retour
 */
...
export class BonsRetour extends BaseModel {
  constructor() {
    super('bons-retour.bonsretour', null);
    this._name = 'bons-retour.bonsretour';
    this._description = 'BonsRetour';
    this._table = 'bons-retours';
    this._idField = 'id';
  }

  async search(domain = [], options = {}) {
    let query = `SELECT * FROM bons-retours WHERE 1=1`;
    const params = [];
    let paramCount = 0;
