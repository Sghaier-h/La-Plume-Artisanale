...
export const getCrmOpportunity = async (req, res) => {
  try {
    ...
    return handleError(res, error, 'getCrmOpportunity');
  }
};
...
export const getCrmOpportunityById = async (req, res) => {
  try {
    ...
    return handleError(res, error, 'getCrmOpportunityById');
  }
};
...
export const createCrmOpportunity = async (req, res) => {
  try {
    ...
    return handleError(res, error, 'createCrmOpportunity');
  }
};
...
export const updateCrmOpportunity = async (req, res) => {
  try {
    ...
    return handleError(res, error, 'updateCrmOpportunity');
  }
};
...
export const deleteCrmOpportunity = async (req, res) => {
  try {
    ...
    return handleError(res, error, 'deleteCrmOpportunity');
  }
};
