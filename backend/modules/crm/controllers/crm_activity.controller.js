/**
 * Contrôleur CrmActivityController - Module crm
 */
...
export const getCrmActivity = async (req, res) => {
  try {
    ...
    return handleError(res, error, 'getCrmActivity');
  }
};
...
export const getCrmActivityById = async (req, res) => {
  try {
    ...
    return handleError(res, error, 'getCrmActivityById');
  }
};
...
export const createCrmActivity = async (req, res) => {
  try {
    ...
    return handleError(res, error, 'createCrmActivity');
  }
};
...
export const updateCrmActivity = async (req, res) => {
  try {
    ...
    return handleError(res, error, 'updateCrmActivity');
  }
};
...
export const deleteCrmActivity = async (req, res) => {
  try {
    ...
    return handleError(res, error, 'deleteCrmActivity');
  }
};
