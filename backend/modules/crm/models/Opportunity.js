...
export class Opportunity extends BaseModel {
  constructor() {
    super('crm.opportunity', null);
    this._name = 'crm.opportunity';
    this._description = 'Opportunity';
    this._table = 'opportunitys';
    this._idField = 'id';
  }

  async search(domain = [], options = {}) {
    let query = `SELECT * FROM opportunitys WHERE 1=1`;
    const params = [];
    let paramCount = 0;
