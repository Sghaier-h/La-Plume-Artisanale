...
export class Activity extends BaseModel {
  constructor() {
    super('crm.activity', null);
    this._name = 'crm.activity';
    this._description = 'Activity';
    this._table = 'activitys';
    this._idField = 'id';
  }

  async search(domain = [], options = {}) {
    let query = `SELECT * FROM activitys WHERE 1=1`;
    const params = [];
    let paramCount = 0;
