/**
 * ParametresCatalogue Model - Module parametres-catalogue
 */
...
export class ParametresCatalogue extends BaseModel {
  constructor() {
    super('parametres-catalogue.parametrescatalogue', null);
    this._name = 'parametres-catalogue.parametrescatalogue';
    this._description = 'ParametresCatalogue';
    this._table = 'parametres-catalogues';
    this._idField = 'id';
  }

  async search(domain = [], options = {}) {
    let query = `SELECT * FROM parametres-catalogues WHERE 1=1`;
    const params = [];
    let paramCount = 0;
