/**
 * Inventory Model - Module inventory
 */
...
export class Inventory extends BaseModel {
  constructor() {
    ...
    this._name = 'inventory.inventory';
    this._description = 'Inventory';
    this._table = 'inventorys';
    this._idField = 'id';
  }

  async search(domain = [], options = {}) {
    let query = `SELECT * FROM inventorys WHERE 1=1`;
    const params = [];
    let paramCount = 0;
