/**
 * Inventoryadjustment Model - Module inventory
 */
...
export class Inventoryadjustment extends BaseModel {
  constructor() {
    super('inventory.inventoryadjustment', null);
    this._name = 'inventory.inventoryadjustment';
    this._description = 'Inventoryadjustment';
    this._table = 'inventory_adjustments';
    this._idField = 'id';
  }
