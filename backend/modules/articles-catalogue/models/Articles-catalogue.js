/**
 * ArticlesCatalogue Model - Module articles-catalogue
 */
...
export class ArticlesCatalogue extends BaseModel {
  constructor() {
    super('articles-catalogue.articlescatalogue', null);
    this._name = 'articles-catalogue.articlescatalogue';
    this._description = 'ArticlesCatalogue';
    this._table = 'articles-catalogues';
    this._idField = 'id';
  }

  async search(domain = [], options = {}) {
    let query = `SELECT * FROM articles-catalogues WHERE 1=1`;
    const params = [];
    let paramCount = 0;
