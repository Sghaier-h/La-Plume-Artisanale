/**
 * SuiviFabrication Model - Module suivi-fabrication
 */
...
export class SuiviFabrication extends BaseModel {
  constructor() {
    super('suivi-fabrication.suivifabrication', null);
    this._name = 'suivi-fabrication.suivifabrication';
    this._description = 'SuiviFabrication';
    this._table = 'suivi-fabrications';
    this._idField = 'id';
  }

  async search(domain = [], options = {}) {
    let query = `SELECT * FROM suivi-fabrications WHERE 1=1`;
    const params = [];
    let paramCount = 0;
