/**
 * Mrprouting Model - Module mrp
 */

import BaseModel from '../../../src/core/BaseModel.js';
import { pool } from '../../../src/utils/db.js';

export class Mrprouting extends BaseModel {
  constructor() {
    super('mrp.mrprouting', null);
    this._name = 'mrp.mrprouting';
    this._description = 'Mrprouting';
    this._table = 'mrp_routings';
    this._idField = 'id';
  }

  async search(domain = [], options = {}) {
    let query = `SELECT * FROM mrp_routings WHERE 1=1`;
    const params = [];
    let paramCount = 0;
