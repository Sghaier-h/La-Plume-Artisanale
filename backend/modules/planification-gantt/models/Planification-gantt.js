/**
 * PlanificationGantt Model - Module planification-gantt
 */
...
export class PlanificationGantt extends BaseModel {
  constructor() {
    super('planification-gantt.planificationgantt', null);
    this._name = 'planification-gantt.planificationgantt';
    this._description = 'PlanificationGantt';
    this._table = 'planification-gantts';
    this._idField = 'id';
  }

  async search(domain = [], options = {}) {
    let query = `SELECT * FROM planification-gantts WHERE 1=1`;
    const params = [];
    let paramCount = 0;
