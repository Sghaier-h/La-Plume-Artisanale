...
# Test 2: Vérification des fichiers backend
Write-Host "📋 Test 2 : Verification des controllers backend..." -ForegroundColor Yellow
$controllers = @(
...
# Test 3: Vérification des routes backend
Write-Host "📋 Test 3 : Verification des routes backend..." -ForegroundColor Yellow
$routes = @(
    "articles.routes.js",
    "clients.routes.js",
    "commandes.routes.js",
...
# Test 4: Vérification des pages frontend
...
# Test 5: Vérification des services API
...
# Test 7: Vérification de la configuration backend
...
# Test 8: Vérification des dépendances
...
# Test 9: Vérification de la configuration .env
...
# Test 10: Test de connexion API (si backend démarré)
