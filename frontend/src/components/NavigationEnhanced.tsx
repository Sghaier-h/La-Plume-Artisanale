  ...
  const rawCategories: MenuCategory[] = [
    // 1. CRM & Clients
    {
      ...
      items: [
        ...
        { path: '_todo/crm/contacts', label: 'Contacts', icon: Contact, badge: '_todo' },
        { path: '_todo/crm/interactions', label: 'Interactions', icon: HeartHandshake, badge: '_todo' },
      ],
    },
    ...
    // 2. Produits
    {
      ...
      items: [
        ...
        { path: '_todo/produits/seo', label: 'SEO produits web', icon: FileSearch, badge: '_todo' },
      ],
    },
    ...
    // 3. Stock
    {
      ...
      items: [
        ...
        { path: '_todo/stock/alertes', label: 'Alertes stock', icon: AlertTriangle, badge: '_todo' },
      ],
    },
    ...
    // 4. Fabrication
    {
      ...
      items: [
        ...
        { path: '_todo/fabrication/postes', label: 'Postes de travail', icon: HardHat, badge: '_todo' },
        {
          path: '/machines',
    ...
    // 9. Marketing
    {
      ...
      items: [
        ...
        { path: '_todo/marketing/segments', label: 'Segments clients', icon: Target, badge: '_todo' },
        { path: '/publicite', label: 'Comptes externes (Meta, Google Ads…)', icon: Share2, permission: 'marketing.account.read' },
        { path: '_todo/marketing/stats', label: 'Stats & performance', icon: LineChart, badge: '_todo' },
      ],
    },
    ...
    // 10. E-commerce
    {
      ...
      items: [
        ...
        { path: '_todo/ecommerce/stock-sync', label: 'Stock synchronisé vers sites', icon: RefreshCw, badge: '_todo' },
        { path: '_todo/ecommerce/stats', label: 'Statistiques ventes web', icon: TrendingUp, badge: '_todo' },
        { path: '_todo/ecommerce/panier-abandonne', label: 'Panier abandonné', icon: Undo2, badge: '_todo' },
        { path: '_todo/ecommerce/fidelite', label: 'Programme fidélité web', icon: Gift, badge: '_todo' },
    ...
    // 11. Intelligence Artificielle
    {
      ...
      permission: 'ai.read',
      items: [
        { path: '_todo/ia/agents-actifs', label: 'Agents actifs', icon: Bot, badge: '_todo' },
        { path: '_todo/ia/constats', label: 'Constats à traiter', icon: AlertCircle, badge: '_todo' },
        { path: '_todo/ia/rapports', label: 'Rapports générés', icon: FileBarChart2, badge: '_todo' },
        { path: '_todo/ia/config', label: 'Configuration agents', icon: SettingsCog, badge: '_todo' },
        { path: '_todo/ia/couts-llm', label: 'Coûts & consommation LLM', icon: CoinIcon, badge: '_todo' },
      ],
    },
    ...
    // 13. Dashboards — visibles pour tous (admin inclus pour supervision)
    {
      ...
      items: [
        ...
        { path: '_todo/dashboards/comptable', label: 'Comptable', icon: BookOpen, badge: '_todo' },
    ...
    // 14. Mon compte
    {
      ...
      icon: UserCog,
      items: [
        { path: '_todo/moncompte/profil', label: 'Profil', icon: UserCircle, badge: '_todo' },
        { path: '_todo/moncompte/email', label: 'Paramètre Email (SMTP perso)', icon: Mail, badge: '_todo' },
        { path: '_todo/moncompte/whatsapp', label: 'Paramètre WhatsApp', icon: MessageCircle, badge: '_todo' },
      ],
    },
    ...
    // 15. Paramètres
    {
      ...
      items: [
        ...
        { path: '_todo/parametres/crm', label: 'Paramètre CRM', icon: Users, badge: '_todo' },
        ...
        { path: '_todo/parametres/vente', label: 'Paramètre Vente', icon: ShoppingBag, badge: '_todo' },
        { path: '_todo/parametres/achats', label: 'Paramètre Achats & Fournisseurs', icon: ShoppingCart, badge: '_todo' },
        { path: '_todo/parametres/comptabilite', label: 'Paramètre Comptabilité', icon: BookOpen, badge: '_todo' },
        { path: '_todo/parametres/stock', label: 'Paramètre Stock', icon: Warehouse, badge: '_todo' },
        { path: '_todo/parametres/fabrication', label: 'Paramètre Fabrication', icon: Factory, badge: '_todo' },
        { path: '_todo/parametres/transporteurs', label: 'Paramètre Transporteurs', icon: Truck, badge: '_todo' },
        { path: '_todo/parametres/commissions', label: 'Paramètre Commissions', icon: Percent, badge: '_todo' },
        ...
        { path: '_todo/parametres/pays-tva', label: 'Paramètre Pays & TVA', icon: MapPin, badge: '_todo' },
