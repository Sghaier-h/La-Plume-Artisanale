/**
 * Script pour convertir account_move.controller.js pour utiliser directement SQL
 */
...
const controllerPath = path.join(__dirname, '../modules/account/controllers/account_move.controller.js');
...
export const getAccountMoves = async (req, res) => {
  try {
    ...
    query += \` ORDER BY date_facturation DESC LIMIT $\${paramIndex} OFFSET $\${paramIndex + 1}\`;
...
console.log('✅ account_move.controller.js converti');
